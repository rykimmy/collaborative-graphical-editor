 ...
 * @author Ryan Kim (TA: Caroline Hall), 22W, added Constructor and setCorners() method
 * @author Anand McCoole (TA: Jason Pak), 22W, added Constructor and setCorners() method
 */
public class Rectangle implements Shape {
	...
	/**
	 * Constructor for starting a new rectangle
	 * @param x1,y1; the coordinates of one corner of the rectangle
	...
	/**
	 * Constructor for a completed rectangle
	 * @param x1,y1; coordinates of one corner of the rectangle
	 * @param x2,y2; coordinates of the other corner of the rectangle
	 * @param color, color of the rectangle
	 */
	 ...
	 * @param x2,y2; coordinates of the other corner
	 */
